        ...
        <div class="border border-default-200 rounded-lg">
            ...
            <div class="p-6">
                <input id="LoggingEmailAddress"
                    class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200" type="text"
                    placeholder="Enter Coupon Code" fdprocessedid="lzxjd">

                <div class="flex justify-end mt-4">
                    <VueButton name="Apply coupon" type="button" className="py-3" />
                </div>
            </div>
        </div>
    </div>
