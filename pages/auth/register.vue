    ...
    <div
        ...
        <div class="container">
            <div class="flex justify-center items-center lg:max-w-lg">
                <div class="flex flex-col h-full">
                    <div class="shrink">
                        <div class="pb-10">
                            <a class="flex items-center" href="home.html">
                                <img alt="logo" class="h-12 flex dark:hidden" src="/assets/logo-dark-6dbab3e1.png">
                                <img alt="logo" class="h-12 hidden dark:flex" src="/assets/logo-light-35c89c2c.png">
                            </a>
                        </div>
                        <div class="">
                        ...
                        <div class="pt-16">
                            <div class="mb-6">
                                ...
                                <input
                                    ...
                                    id="FullName" placeholder="Enter your Name" type="email" fdprocessedid="nt15uk">
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex" data-x-password="">
                                    ...
                                    <button
                                        ...
                                        id="password-addon" fdprocessedid="j1pg8p">
                            ...
                            <div class="mb-6">
                                <div class="flex items-center justify-center gap-4">
                                    <a class="" href="javascript:void(0)">
                                        <img class="h-8 w-8" src="/assets/google-48c5b900.svg">
                                    </a>
                                    <a class="" href="javascript:void(0)">
                                        <img class="h-8 w-8" src="/assets/facebook-b2928e06.svg">
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div>
            <div class="absolute top-1/2 -translate-y-1/3 start-0 end-0 w-full -z-10">
                <img class="w-full opacity-50 flex"
            ...
            <div class="absolute top-0 end-0 hidden xl:flex h-5/6">
                <img class="w-full z-0" src="/assets/auth-bg-d79436e2.png">
            </div>
        </div>
    </div>
</template>