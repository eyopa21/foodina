                                            ...
                                            <table class="min-w-full divide-y divide-default-200">
                                                <thead class="bg-default-400/10">
                                                    <tr>
                                                        <th scope="col"
                                                            ...
                                                            Products</th>
                                                        <th scope="col"
                                                            class="px-5 py-3 text-start text-xs font-medium text-default-500 uppercase">
                                                            Price</th>
                                                        <th scope="col"
                                                            class="px-5 py-3 text-start text-xs font-medium text-default-500 uppercase">
                                                            Quantity</th>
                                                        <th scope="col"
                                                            class="px-5 py-3 text-center text-xs font-medium text-default-500 uppercase">
                                                            Sub-Total</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="divide-y divide-default-200">
                                                        ...
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div class="flex items-center gap-2">
                                                                <button fdprocessedid="t3bs79"><svg
                                                                        ...
                                                                        class="lucide lucide-x-circle w-5 h-5 text-default-400">
                                                                        <circle cx="12" cy="12" r="10"></circle>
                                                                        <path d="m15 9-6 6"></path>
                                                                        <path d="m9 9 6 6"></path>
                                                                    </svg></button>
                                                                <img src="/assets/onion-rings-6902e6d8.png"
                                                                    class="h-18 w-18">
                                                                <h4 class="text-sm font-medium text-default-800">Onion Rings
                                                                </h4>
                                                            </div>
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap text-sm text-default-800">$29
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    fdprocessedid="wpuepa">+</button>
                                                            </div>
                                                        </td>
                                                        <td
                                                            class="px-5 py-3 whitespace-nowrap text-sm text-center text-default-800">
                                                            $50</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div class="flex items-center gap-2">
                                                                <button fdprocessedid="gxfpyg"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                ...
                                                                <img src="/assets/burrito-bowl-79a7c64f.png"
                                                                    class="h-18 w-18">
                                                                <h4 class="text-sm font-medium text-default-800">Burrito
                                                                    Bowl</h4>
                                                            </div>
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap text-sm text-default-800">$50
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div
                                                                class="inline-flex justify-between border border-default-200 p-1 rounded-full">
                                                                <button type="button"
                                                                    class="minus flex-shrink-0 bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center"
                                                                    fdprocessedid="j9mgt">–</button>
                                                                <input type="text"
                                                                    class="w-8 border-0 text-sm text-center text-default-800 focus:ring-0 p-0 bg-transparent"
                                                                    value="3" min="0" max="100" readonly=""
                                                                    fdprocessedid="vz2i4c">
                                                                <button type="button"
                                                                    class="plus flex-shrink-0 bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center"
                                                                    fdprocessedid="t6784">+</button>
                                                            </div>
                                                        </td>
                                                        <td
                                                            class="px-5 py-3 whitespace-nowrap text-sm text-center text-default-800">
                                                    ...
                                                    <tr>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div class="flex items-center gap-2">
                                                                <button fdprocessedid="s1ggx6"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                ...
                                                                <img src="/assets/garlic-herb-bread-8a00951d.png"
                                                                    class="h-18 w-18">
                                                                <h4 class="text-sm font-medium text-default-800">Garlic
                                                                    &amp; Herb Bread</h4>
                                                            </div>
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap text-sm text-default-800">$42
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div
                                                                class="inline-flex justify-between border border-default-200 p-1 rounded-full">
                                                                <button type="button"
                                                                    class="minus flex-shrink-0 bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center"
                                                                    fdprocessedid="gkjss">–</button>
                                                                <input type="text"
                                                                    class="w-8 border-0 text-sm text-center text-default-800 focus:ring-0 p-0 bg-transparent"
                                                                    value="2" min="0" max="100" readonly=""
                                                                    fdprocessedid="16s91o">
                                                                <button type="button"
                                                                    class="plus flex-shrink-0 bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center"
                                                                    fdprocessedid="3howxj">+</button>
                                                            </div>
                                                        </td>
                                                        <td
                                                            class="px-5 py-3 whitespace-nowrap text-sm text-center text-default-800">
                                                    ...
                                                    <tr>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div class="flex items-center gap-2">
                                                                <button fdprocessedid="hz4lwp"><svg
                                                                        xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                                        stroke="currentColor" stroke-width="2"
                                                                        stroke-linecap="round" stroke-linejoin="round"
                                                                ...
                                                                <img src="/assets/red-velvet-pastry-b09214ba.png"
                                                                    class="h-18 w-18">
                                                                <h4 class="text-sm font-medium text-default-800">Red Velvet
                                                                    Pastry</h4>
                                                            </div>
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap text-sm text-default-800">$68
                                                        </td>
                                                        <td class="px-5 py-3 whitespace-nowrap">
                                                            <div
                                                                class="inline-flex justify-between border border-default-200 p-1 rounded-full">
                                                                <button type="button"
                                                                    class="minus flex-shrink-0 bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center"
                                                                    fdprocessedid="3sw245">–</button>
                                                                <input type="text"
                                                                    class="w-8 border-0 text-sm text-center text-default-800 focus:ring-0 p-0 bg-transparent"
                                                                    value="1" min="0" max="100" readonly=""
                                                                    fdprocessedid="nihlbp">
                                                                <button type="button"
                                                                    class="plus flex-shrink-0 bg-default-200 text-default-800 rounded-full h-6 w-6 text-sm inline-flex items-center justify-center"
                                                                    fdprocessedid="njqbj">+</button>
                                                            </div>
                                                        </td>
                                                        <td
                                                            class="px-5 py-3 whitespace-nowrap text-sm text-center text-default-800">
                            ...
                            <div class="border-t border-default-200 px-6 py-5">
                                <div class="flex flex-wrap justify-between items-center gap-2">
                                    <button
                                        ...
                                        fdprocessedid="bnswjr">
                                        Return to Shop
                                    </button>

                                    <button
                                        class="inline-flex items-center justify-center rounded-full border border-primary text-primary hover:bg-primary hover:text-white px-6 py-3 text-center text-sm font-medium shadow-sm transition-all duration-500"
                                        fdprocessedid="fn2peh">
                                        Update Cart
                                    </button>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="border border-default-200 rounded-lg p-5 mb-5">
                            ...
                            <a href="checkout.html"
                                class="w-full inline-flex items-center justify-center rounded-full border border-primary bg-primary px-10 py-3 text-center text-sm font-medium text-white shadow-sm transition-all duration-500 hover:bg-primary-500">Proceed
                                to Checkout</a>
                        </div>
                        ...
                        <div class="border border-default-200 rounded-lg">
                            ...
                            <div class="p-6">
                                <input id="LoggingEmailAddress"
                                    class="block w-full bg-transparent rounded-full py-2.5 px-4 border border-default-200"
                                    type="text" placeholder="Enter Coupon Code" fdprocessedid="lzxjd">
                                ...
                                <div class="flex justify-end mt-4">
                                    <button
                                        ...
                                        fdprocessedid="d5rc3w">Apply Coupon</button>
                                </div>
                            </div>
                        </div>
                    </div>
